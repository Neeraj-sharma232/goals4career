        ...
        <section class="py-10  bg-[#EAEAEA]">
            <div class="grid lg:grid-cols-3 gap-6 lg:mx-20 md:mx-10 mx-4">
                <div class="lg:col-span-2 my-auto">
                    <h2 class="text-4xl text-[#19468A] font-semibold my-6">Professional Client Website Senior Level (10+ Years)</h2>
                    <p class="lg:text-lg my-6 text-black">There is increasing need to be around on the web, as organizations are shifting from hard copies to soft copies and online easy access to candidate details, if available! A senior level member of an organization must be present on the web with a personal portfolio website to leave a long lasting impression.</p>
                ...
                <div>
                    <form action="mannage_cart.php" method="POST">
                        <div class="block text-center rounded-lg bg-white p-6 shadow-[0_2px_15px_-3px_rgba(47,100,215,1.02),0_10px_20px_-2px_rgba(47,100,215,1.01)] dark:bg-neutral-700">
                            ...
                            <h2 class="text-3xl text-[#19468A] font-semibold my-2">RS 89,999</h2>
                            ...
                            <input type="hidden" name="Service" value="Professional Client Website  Senior Level (10+ Years)">
