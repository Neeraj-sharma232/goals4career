        ...
        <section class="py-10  bg-[#EAEAEA]">
            <div class="grid lg:grid-cols-3 gap-6 lg:mx-20 md:mx-10 mx-4">
                <div class="lg:col-span-2 my-auto">
                    <h2 class="text-4xl text-[#19468A] font-semibold my-6">Professional Client Website Fresher Level (0-3 Years)</h2>
                    <p class="lg:text-lg my-6 text-black">In this digital age, employers are increasingly searching for candidates on the web, so, being present on the web is a crucial need which gives you an edge over other candidates applying for the job. Having a personal portfolio website to your name is better than showing the old boring resume.</p>

                </div>
                <div>
                    <div class="h-full w-full">
                        <img src="assets/services_img/img13.png" alt="" class="w-full  rounded shadow-sm data-[te-lightbox-disabled]:cursor-auto" />
                    </div>
                </div>
        </section>
                    ...
                    <form action="mannage_cart.php" method="POST">
                        <div class="block text-center rounded-lg bg-white p-6 shadow-[0_2px_15px_-3px_rgba(47,100,215,1.02),0_10px_20px_-2px_rgba(47,100,215,1.01)] dark:bg-neutral-700">
                            <h5 class="mb-2 text-xl font-semibold leading-tight text-neutral-800 dark:text-neutral-50">
                                ...
                                Fresher Level (0-3 Years)
                            </h5>
                            <h2 class="text-3xl text-[#19468A] font-semibold my-2">RS 36,999</h2>
                            ...
                            <input type="hidden" name="Service" value="Professional Client Website Fresher Level (0-3 Years)">
